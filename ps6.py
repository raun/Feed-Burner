...
class PhraseTrigger(Trigger):
    def __init__(self,word):
        self.word=word
    def evaluate(self,story):
        return self.word in story.getGuid() + story.getTitle() + story.getSubject() + story.getSummary() 
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    if triggerType == "NOT":
        triggerMap[name]=NotTrigger(params)
...
def readTriggerConfig(filename):
    ...
    tha correspond to the rules set
...
def main_thread(master):
    ...
    try:
        ...
        print "created dummy triggerlist"
        # TODO: Problem 11
        # After implementing makeTrigger, uncomment the line below:
        triggerlist = readTriggerConfig("triggers.txt")
        print "created triggerlist from file"
